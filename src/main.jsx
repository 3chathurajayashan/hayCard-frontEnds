...
const router = createBrowserRouter([
  ...
  { path: '/addDashboard', element: <AddDashboard /> },
  { path: '/editDashboard', element: <EditSample /> },
  { path: '/preSign', element: <PreSign /> },
  { path: '/guide', element: <Guide /> },
  { path: '/sample-details', element: <SampleDetails /> },
  { path: '/test', element: <Feature /> },
  { path: '/ChemHome', element: <ChemHome /> },
  { path: '/storage', element: <Storage /> },
  { path: '/purchasing', element: <ChemicalRequestPage /> },
  { path: '/cushome', element: <SampleMenu /> },
  { path: '/samplein', element: <SampleIn /> },
